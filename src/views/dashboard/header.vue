<template>
    ...
    <div class="mt-12">
    <div v-if="isSettingOpen === true" @mouseover="isSettingOpen === true" class="w-0 h-60 flex justify-end ">
      <div class="-ml-40 mr-4 mt-1 rounded w-40 h-60 bg-green-300 z-[99999]">sfdsf</div>
    </div>
    </div>
</template>
