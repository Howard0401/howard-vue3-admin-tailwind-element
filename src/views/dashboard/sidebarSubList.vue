<template>
  <div class="w-sidbar"></div>
  <div class="w-0 z-40 fixed">
      <div :style="`height: ${1 + 2.5*computedCurSmallIconHoverIdx}rem; width:8rem;`" 
            class="ml-conpensate_side_bar_sublist">
      </div>
      <div v-for="(n,idx) in ['1','2','3','4']" :kzey="idx" 
